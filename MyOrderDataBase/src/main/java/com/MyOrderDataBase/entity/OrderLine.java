...
@Entity(name = "ORDERLINE_TABEL")
@Table(name = "ORDERLINE_TABEL")
public class OrderLine implements Serializable {
    ...
    public OrderLine() {}
    public OrderLine(Long idOrder, String goods, Integer count, Double price) {
        Assert.hasText(idOrder.toString(), "order can not be empty or null!");
